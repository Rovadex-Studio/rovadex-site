...
if ( ! class_exists( 'Rovadex_Widget_Area' ) ) {

	class Rovadex_Widget_Area {
		...
		function __construct() {
			...
			add_action( 'rovadex_render_widget_area', array( $this, 'render' ) );
		}
		...
		public function render( $area_id ) {
			...
			$area_id        = apply_filters( 'rovadex_rendering_current_widget_area', $area_id );
			...
			$classes = apply_filters( 'rovadex_widget_area_classes', $classes, $area_id );
	...
	function rovadex_widget_area() {
		return Rovadex_Widget_Area::get_instance();
	}
