 ...
 */
add_filter( 'template_include', array( 'Rovadex_Wrapping', 'wrap' ), 99 );
add_filter( 'rovadex_wrap_base', 'rovadex_wrap_base_cpts' );
 ...
 */
function rovadex_template_path() {
 ...
 */
function rovadex_template_base() {
	return Rovadex_Wrapping::$base;
}

if ( ! class_exists( 'Rovadex_Wrapping' ) ) {
	...
	class Rovadex_Wrapping {
		...
		/**
		 * Initialize new instance of Rovadex_Wrapping class by setting a variable for the $slug (which defaults to base)
		...
		public function __toString() {
			$this->templates = apply_filters( 'rovadex_wrap_' . $this->slug, $this->templates );
		 ...
		 * and $base as static variables in Rovadex_Wrapping class.
		 *
		 * @since 1.0.0
 ...
 */
function rovadex_wrap_base_cpts( $templates ) {
