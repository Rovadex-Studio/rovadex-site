 ...
 * @return array
 */
function rovadex_share_buttons( $context = 'loop', $args = array(), $config = array() ) {
	...
	/*
	if ( ! rovadex_is_meta_visible( $meta, $context ) ) {
		return;
	}
	*/
	...
	$default_config = apply_filters( 'rovadex_default_config_share_buttons', array(
	...
	$share_item_html = apply_filters( 'rovadex_share_button_html',
