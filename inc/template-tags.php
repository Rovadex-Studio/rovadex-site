			...
			<svg version="1.1" id="rovadex-logo-svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="350px" x="0px" y="0px" viewBox="0 0 415 157" xml:space="preserve">
				<g id="inner">
					<g id="XMLID_7_">
						...
						<text id="XMLID_22_" font-family="Sarina-Regular" font-size="120.0038px"; transform="matrix(1 7.999744e-03 -7.999744e-03 1 41.2318 112.8473)" class="main-symbol" fill="#ffffff">R</text>
					</g>
