...
class Cherry_Subscribe_Follow_Widget extends Cherry_Abstract_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = esc_html__( 'Display subscribe form and follow links.', 'rovadex-site' );
		$this->widget_id          = 'rovadex_widget_subscribe_follow';
		$this->widget_name        = esc_html__( 'Subscribe and Follow', 'rovadex-site' );
		$this->settings           = array(
			'enable_subscribe' => array(
				...
				'options' => array(
					'enable_subscribe' => esc_html__( 'Enable Subscribe Box', 'rovadex-site' ),
				),
			),
			'subscribe_title' => array(
				'type'  => 'text',
				'value' => esc_html__( 'Subscribe', 'rovadex-site' ),
				'label' => esc_html__( 'Subscribe Title', 'rovadex-site' ),
			),
			'subscribe_message' => array(
				'type'  => 'textarea',
				'label' => esc_html__( 'Subscribe text message', 'rovadex-site' ),
			),
			'subscribe_input' => array(
				'type'  => 'text',
				'value' => esc_html__( 'Enter your email', 'rovadex-site' ),
				'label' => esc_html__( 'Subscribe input placeholder', 'rovadex-site' ),
			),
			'subscribe_submit' => array(
				'type'  => 'text',
				'value' => esc_html__( 'Subscribe', 'rovadex-site' ),
				'label' => esc_html__( 'Subscribe submit label', 'rovadex-site' ),
			),
			'subscribe_success' => array(
				'type'  => 'text',
				'value' => esc_html__( 'You successfully subscribed', 'rovadex-site' ),
				'label' => esc_html__( 'Subscribe success', 'rovadex-site' ),
			),
			'enable_follow' => array(
				'type'   => 'checkbox',
				'value'  => array(
				...
				'options' => array(
					'enable_follow' => esc_html__( 'Enable Follow Box', 'rovadex-site' ),
				),
			),
			'follow_title' => array(
				'type'  => 'text',
				'value' => esc_html__( 'Follow', 'rovadex-site' ),
				'label' => esc_html__( 'Follow Title', 'rovadex-site' ),
			),
			'follow_message' => array(
				'type'  => 'textarea',
				'label' => esc_html__( 'Follow text message', 'rovadex-site' ),
			),
			'enable_background' => array(
				...
				'options' => array(
					'enable_background' => array(
						'label' => esc_html__( 'Enable Custom Background', 'rovadex-site' ),
			...
			'background_image' => array(
				'type'               => 'media',
				'label'              => esc_html__( 'Background Image', 'rovadex-site' ),
				'upload_button_text' => esc_html__( 'Choose Image', 'rovadex-site' ),
				'multi_upload'       => false,
			...
			'invert_text_colorscheme' => array(
				...
				'master'  => 'background_image',
				'options' => array(
					'invert_text_colorscheme' => esc_html__( 'Use "Invert scheme" for text color', 'rovadex-site' ),
				),
			),
			'background_position' => array(
				'type'    => 'select',
				'label'   => esc_html__( 'Background Position', 'rovadex-site' ),
				'value'   => 'center',
				'options' => array(
					'top-left'      => esc_html__( 'Top Left', 'rovadex-site' ),
					'top-center'    => esc_html__( 'Top Center', 'rovadex-site' ),
					'top-right'     => esc_html__( 'Top Right', 'rovadex-site' ),
					'center-left'   => esc_html__( 'Middle Left', 'rovadex-site' ),
					'center'        => esc_html__( 'Middle Center', 'rovadex-site' ),
					'center-right'  => esc_html__( 'Middle Right', 'rovadex-site' ),
					'bottom-left'   => esc_html__( 'Bottom Left', 'rovadex-site' ),
					'bottom-center' => esc_html__( 'Bottom Center', 'rovadex-site' ),
					'bottom-right'  => esc_html__( 'Bottom Right', 'rovadex-site' ),
				),
				'master' => 'background_image',
			),
			'background_repeat' => array(
				...
				'value'   => 'no-repeat',
				'options' => array(
					'repeat'    => esc_html__( 'Repeat', 'rovadex-site' ),
					'repeat-x'  => esc_html__( 'Repeat X', 'rovadex-site' ),
					'repeat-y'  => esc_html__( 'Repeat Y', 'rovadex-site' ),
					'no-repeat' => esc_html__( 'No repeat', 'rovadex-site' ),
				),
				'master' => 'background_image',
			),
			'background_size' => array(
				'type'    => 'select',
				'label'   => esc_html__( 'Background Size', 'rovadex-site' ),
				'value'   => 'inherit',
				'options' => array(
					'cover'   => esc_html__( 'Cover', 'rovadex-site' ),
					'contain' => esc_html__( 'Contain', 'rovadex-site' ),
					'auto'    => esc_html__( 'Auto', 'rovadex-site' ),
				),
				'master' => 'background_image',
			),
			'background_color' => array(
				'type'   => 'colorpicker',
				'label'  => esc_html__( 'Background Color', 'rovadex-site' ),
				'master' => 'background_image',
			),
		);

		add_action( 'wp_ajax_rovadex_subscribe', array( $this, 'process_subscribe' ) );
		add_action( 'wp_ajax_nopriv_rovadex_subscribe', array( $this, 'process_subscribe' ) );

		$this->errors = array(
			'nonce'     => esc_html__( 'Security validation failed', 'rovadex-site' ),
			'mail'      => esc_html__( 'Please, provide valid mail', 'rovadex-site' ),
			'mailchimp' => esc_html__( 'Please, set up MailChimp API key and List ID', 'rovadex-site' ),
			'internal'  => esc_html__( 'Internal error. Please, try again later', 'rovadex-site' ),
		);

		$this->nonce = wp_create_nonce( 'rovadex-subscribe-nonce' );
	...
	public function widget( $args, $instance ) {
		...
		if ( $subscribe_enabled && $subscribe_template && $api_key && $list_id ) {
			...
			esc_html_e( 'Please set up MailChimp API key and List ID', 'rovadex-site' );
		}
	...
	public function get_social_nav() {
		return rovadex_get_social_list( 'widget' );
	}
	...
	public function get_subscribe_submit( $class ) {
		...
		$subscribe_submit = rovadex_render_icons( $subscribe_submit );

		return '<a href="#" class="subscribe-block__submit ' . esc_attr( $class ) . '"><i class="fa fa-arrow-right" aria-hidden="true"></i></a>';
	}
	...
	public function process_subscribe() {
		...
		if ( ! isset( $_POST['nonce'] ) || ! wp_verify_nonce( $_POST['nonce'], 'rovadex-subscribe-nonce' ) ) {
...
add_action( 'widgets_init', 'rovadex_register_subscribe_follow_widgets' );
function rovadex_register_subscribe_follow_widgets() {
